...
// stop all recording if user not in the speaking conversation page .....added at(26/9/24)
// let speakingPagesArrayNames = [];
// for (let i = 1; i <= 20; i++) {
//     for (let sec = 1; sec <= 3; sec++) {
//         // console.log(`Test${i}Sec${sec}`);
//         speakingPagesArrayNames.push(`Test${i}Sec${sec}`)
//     }
// }
