...
function ServicesReadingAllTest() {
    ...
    useEffect(() => {
        axios({
            ...
            url: 'https://node-js-express-login-example.onrender.com/api/user/AllReadingResults/' + localStorage.getItem('userEmail'),
            headers: {
                    ...
                    <div className='grid  justify-center align-middle'>
                        <button className=' flex gap-2  rounded borde-1 border-gray-300 bg-white h-full '>
                            ...
                            >Cambridge tests
                                ...
                                <Image src={cambrigeIcon} className='w-[15px] translate-y-[2px]' alt='' />
                            </button>
                                    ...
                                    <div className="flex flex-col justify-center relative ">
                                        <div
                                            ...
                                            <div className="w-1/3 bg-white grid place-items-center">
                                                <Image src={Cambridge18} className="rounded-xl h-[80%] translate-y-[-10px] sm:translate-x-[0px]" alt='' />
                                            </div>
                                ...
                                >
                                    <div className="flex flex-col justify-center relative ">
                                        <div
                                            className="relative flex flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-xl p-[17px] pb-[0px] w-auto h-auto border border-white bg-white">
                                            <div className="w-1/3 bg-white grid place-items-center">
                                                <Image src={Cambridge17} className="rounded-xl h-[80%] translate-y-[-10px] sm:translate-x-[0px]" alt='' />
                                            </div>
                                            <div className="w-2/3 bg-white flex flex-col space-y-2 p-3 translate-y-[-3px] sm:translate-y-[0px]">
                                                <div className="flex justify-between item-center gap-1">
                                                    {/* <p className="text-gray-500 font-medium ">Vacations</p> */}
                                ...
                                >
                                    <div className="flex flex-col justify-center relative ">
                                        <div
                                            className="relative flex flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-xl p-[17px] pb-[0px] w-auto h-auto border border-white bg-white ">
                                            <div className="w-1/3 bg-white grid place-items-center">
                                                <Image src={Cambridge17} className="rounded-xl h-[82%] translate-y-[-10px] sm:translate-x-[0px]" alt='' />
                                            </div>
                                            <div className="w-2/3 bg-white flex flex-col space-y-2 p-3 translate-y-[-3px] sm:translate-y-[0px]">
                                                <div className="flex justify-between item-center gap-1">
                                                    {/* <p className="text-gray-500 font-medium ">Vacations</p> */}
                                ...
                                >
                                    <div className="flex flex-col justify-center relative ">
                                        <div
                                            className="relative flex flex-row md:space-x-5 space-y-3 md:space-y-0 rounded-xl shadow-xl p-[17px] pb-[0px] w-auto h-auto border border-white bg-white">
                                            <div className="w-1/3 bg-white grid place-items-center">
                                                <Image src={Cambridge16} className="rounded-xl h-[80%] translate-y-[-10px] sm:translate-x-[0px]" alt='' />
                                            </div>
                                            <div className="w-2/3 bg-white flex flex-col space-y-2 p-3 translate-y-[-3px] sm:translate-y-[0px]">
                                                <div className="flex justify-between item-center gap-1">
                                                    {/* <p className="text-gray-500 font-medium ">Vacations</p> */}
