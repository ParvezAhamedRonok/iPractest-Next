...
function Panel1Q_2() {
  return (
    ...
    onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
      ...
      {/* passage-3 */}
      <div className='text-inherit text-center Titles mt-4 mb-3'>
        <div className="Titles text-inherit font-bold mb-2 text-center">
          ...
          <h5 className=' mt-4 mb-2'>Timur Gareyev – blindfold chess champion</h5> <br />
        </div>
      </div>
