    ...
    onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
      ...
      <div className='text-inherit Titles'>
        <div className="Titles text-inherit font-bold mb-2 text-justify">
          ...
          <h5 className='text-cener w-full mt-2'>The steam car</h5> <br />
          <h5>The successes and failures of the Doble brothers and their steam cars</h5><br />
      ...
      <div className='mb-3'>
        <p className=''>
          <span className='text-xl font-bold mr-2'>F</span> While streaming might seem to help teachers effectively target a student’s ZPD, it can underestimate the importance of peer-to-peer learning. A crucial aspect of constructivist theory is the role of the MKO – ‘more knowledgeable other’ – in knowledge construction. While teachers are traditionally the MKOs in classrooms, the value of knowledgeable student peers must not go unrecognised either.
