        ...
        onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
            <div className='text-inherit Titles'>
                <div className="Titles text-inherit font-bold mb-2 PL-2 text-justify">
                    <div className=''>SECTION 2 <br />Read the text and answer Questions 21 - 27 </div> <br />
                    <div className="mt-2 mb-3">Information Overload</div><br /> <br />
            ...
            <div className='text-inherit Titles'>
                <div className="Titles text-inherit font-bold mb-4 pt-2 text-justify">
                    <div className=''>Questions 28 - 40 <br />Read the text and answer Questions 28 - 40 </div> <br />
                    <div className="mt-2 mb-3">A diverging media</div>
                </div>
            </div>
...
export default Test5Panel1Page2