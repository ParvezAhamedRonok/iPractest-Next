    ...
    onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
      <div>
        <div className="Titles text-inherit font-bold mb-2 text-justify">
          <div className=''>SECTION 2 <br /> Questions 21 - 40</div>
          <div>Read the text and answer Questions 22 - 29</div> <br /> <br />
          <div>INTERNATIONAL STUDENTS HOUSE</div>
        </div>
        <p className='text-justify'>
          <span className='font-bold'>International Students House</span> is a unique club and accommodation centre for British and overseas students in London. It is located in the heart of London's West End and is close to all public transport facilities.
        </p>
      </div>
      <div>
        <div className="Titles text-inheritfont-bold mb-2 text-justify">
          <div>ACCOMMODATION</div>
        </div>
        <p className=''>
          » comfortable accommodation for up to 450 people in single, twin, 3/4 bedded and multi-bedded rooms <br />
          » 44 self-contained flats for married students and families. <br />
      ...
      <div>
        <div className="Titles text-inherit font-bold mb-2 text-center">
          <div className=''>QUESTIONS 30-41</div>
          <div>Read the text below and answer Questions 30-41</div> <br /> 
          <div>RECYCLING GLASS</div>
        </div>
      </div> <br />
      ...
      <div> <br />
        <div className="Titles text-inherit font-bold mb-2 text-justify">
          <div>E - More About Recycling Glass</div>
        </div> <br />
        <p className=''>
          ...
          Since cullet melts at a lower temperature, the more of it you add to a batch of raw materials, the less energy needed to melt it. <br />
      ...
      <div> <br />
        <div className="Titles text-inherit font-bold mb-2 text-justify">
          <div>F - What Not To Recycle</div>
        </div>
        <p className=''>
          Not all glass can be recycled. The following items should not be placed in your recycling bin: <br />

          1, Any glass contaminated with stones, dirt, and food waste <br />
          2, Ceramics, such as dishware, ovenware, and decorative items. <br />
          3, Heat-resistant glass, such as Pyrex. <br />
          4, Mixed colours of broken glass. <br />
          5, Mirror or window glass. <br />
          6, Metal or plastic caps and lids. <br />
          7, Crystal. <br />
          8, Light bulbs: Find out how to recycle here. <br />
          9, Cathode-ray tubes (CRTs) found in some televisions and computer monitors. <br />
          10, Find out how to recycle here.
        </p>
      </div>
