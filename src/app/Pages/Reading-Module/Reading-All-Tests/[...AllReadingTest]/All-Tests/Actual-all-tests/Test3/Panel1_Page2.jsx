    ...
    onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
      <div>
        <div className="Titles text-inherit font-bold mb-2 text-justify">
          <div className=''>Section - 2</div> <br />
          <div> Reading Passage 2
           <br /> Questions 22 - 40</div> <br />
          <h5>Read the text and answer Questions 22 - 27</h5> <br />
          <div>Body Language at Work</div>
        </div>
      </div>
      <div className='mt-4'>
      ...
      <div>
        <div className="Titles text-inherit font-bold mb-2 text-center">
          <div>Reading Passage 3<br /> Questions 28 - 40</div> <br />
          <h5>Read the text and answer Questions 28 - 40</h5>
          <div>Life Beyond Pay</div>
        </div>
      </div> 
      <div className='mt-4'>
        <p className='text-justify mb-3'>
