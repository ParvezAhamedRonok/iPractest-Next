        ...
        onMouseDown={() =>{ makeEditableAndHighlight("green");}}>
            ...
            <div className='text-inherit Titles text-center'>
                <div className="Titles text-inherit font-bold mb-2 PL-2 text-center">
                    <div className=''>Reading Passage-3 , Questions 27-40</div> <br />
                    <div className="mt-2 mb-3">Women and Transport</div>
                </div>
            </div>
...
export default Test8Panel1Page2