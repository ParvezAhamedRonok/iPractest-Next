                                        ...
                                        <div className="flex m-auto gap-2 justify-center mr-3 translate-x-[-10px] sm:translate-x-[-20px]">
                                            {imagePreview && SuccessMsg ?
                                                (<>{
                                                    ...
                                                    <div className="grid">
                                                        <div
                                                            className="inline-block h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-e-transparent align-[-0.125em] text-surface motion-reduce:animate-[spin_1.5s_linear_infinite] dark:text-white ml-[10px] sm:ml-[6px]"
                                                            role="status">
                                                            <span
