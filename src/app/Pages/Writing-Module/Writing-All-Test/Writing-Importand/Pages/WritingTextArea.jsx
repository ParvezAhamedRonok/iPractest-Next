...
function WritingTextArea(task) {
  ...
  // const [DuplicateWord, setDuplicatewords] = useState(0);
  ...
  const PostWritingScors = (x, ieltsScore) => {
    ...
    console.log(MainTaskComplessionResult)
    console.log(typeof ieltsScore)
  ...
  //may be it will not need after adding all score base on data base....
  ...
  function checkWritingAnswer(text, number) {
    ...
    // console.log(text);
    // console.log(writingData.writinTextArea);
  ...
  return (
    <>
      ...
      <div className="Writingmain mb-3">
        {
          changeImageUI ? (
              ...
              >
                <div className="rounded-[20px] pb-2 ">
                  <div className="w-full p-1 flex justify-between">
                    ...
                    <p> Total words: <span className={`text-xl  font-bold ${imageText.split(' ').length < 150 ? "text-red-500" : "text-gray-900"}`}>{imageText.split(' ').length}</span></p>
                  </div>
                  <textarea
            ...
            `}
              ...
              >
                ...
                // onSubmit={writingItems == "11" || writingItems == "111" ? handleLogInPage : handleWritingSubmit}
                >
                  {/* may be no needable closed at 24/02/24 */}
                  {/* <div className="w-full flex p-[3px] sm:p-[0px]  justify-center sm:justify-between gap-1 align-middle text-center rounded border-1 border-gray-300 bg-red-200 ">
          {
            isMobile ? "" : (
              <div className="flex gap-2">
                <div className="text-center w-[30px] h-[30px] translate-y-[2px] rounded-[50%] border-1 border-gray-300 bg-blue-300 "></div>
                <div class="dropping-texts translate-y-[4px]">
                  <div>Connect with us</div>
                  <div>Share your exprience</div>
                  <div>get advice</div>
                  <div>more friendly</div>
                </div>
              </div>
            )
          }
          ...
          <a href="https://www.facebook.com/iPractest" className="underline zoom-in-out-box translate-y-[0px] sm:translate-y-[4px] mr-[0px] sm:mr-[5px]">Check our facebook page</a>
        </div> */}
      ...
      App uploadArea rounded-[20px] shadow-lg bg-white w-[90vw] sm:w-[43vw] translate-y-[-14px] pl-[10px] sm:pl-[50px] `}
          >
            ...
            <div className="grid grid-cols-1 w-full gap-5 box-border pt-2 pb-3">
              <div className="imageBo flex flex-wrap h-auto gap-2">
                {/* if need we use that--important */}
                {/* {imagePreview.length > 0 &&
                  (imagePreview.length > 10 ? (
                    <p className="error">
                      You can't upload more than 10 images! <br />
                      <span>
                        please delete <b> {imagePreview.length - 10} </b> of them{" "}
                      </span>
                    </p>
                  ) : (
                    <button
                    ...
                    >
                      UPLOAD {imagePreview.length} IMAGE
                      {imagePreview.length === 1 ? "" : "S"}
                    </button>
                  ))} */}
            ...
            <section
              ...
              <div className="w-full h-full relative">
                ...
                <div className="w-full flex justify-center align-middle pt-3">
                  {/* {
                    !isMobile && (<button className="rounded-[12px] gap-2 flex justify-center align-middle bg-gradient-to-r from-green-500 to-purple-600 hover:from-green-600 hover:to-blue-600 focus:outline-none text-white  mt-auto w-[130px] p-2 text-[15px]"><MdFeedback className="text-xl mt-[1px] text-white"
                      onClick={() => {
                        userLoginFunction(showFeedbackFunc);
                ...
                <div className=" flex justify-between mb-1 ">
                  {/* <div className="grid sm:flex gap-1 sm:gap-4 translate-y-[-17px] sm:translate-y-[-2px]">
                    <a className="dropbtn text-white zoom-in-out-box"
                      onClick={() => {
                        userLoginFunction(showFeedbackFunc);
                        setWritingText("Need to login first")
                      }}
                    >iPractst-Feedback <MdFeedback className="text-xl sm:text-2xl ml-1 mt-[1px]" /></a>

                    <div className="mt-[3px] sm:mt-[8px]">
                      <a href="https://ipractest.com/SpeakingPage" className="zoom-in-out-box ml-[14px] sm:ml-[0px] rounded-[10px] border-1 border-gray-300 bg-gray-800 hover:bg-gray-100 text-gray-100  text-center hover:text-gray-900 w-auto h-auto flex p-2 gap-2 justify-center align-middle text-[.8rem] sm:text-[1rem]"><i><GiSoundWaves className='text-xl mb-[-5px]' /></i> Go for Speaking Test</a>
                    </div>
                  </div> */}
        ...
        {/* When user want to upload the image after Selected one the
      this pop up will be shown to the user to Crop the image...*/}
        {/* {
        Mainsrc != null && (
          <div className="Result-PopUp pt-[3px]  fixed top-2 left-2 w-[90%] sm:w-[100%] z-[345678900000] ">
            <div className="grid w-[100vw] h-[100%] justify-center align-middle">
              <section className=' grid grid-cols-1 mt-2 rounded  justify-center align-middle w-[100vw] sm:w-[610px] p-4 h-[100vh] box-border overflow-x-auto bg-white '>
                <ReactCrop
                  crop={crop}
                  onChange={(e) => setCrop(e)} >
                  <Image
                    src={Mainsrc != null ? Mainsrc[0] : " "}
                    onLoad={setCropImage}
                    alt="" 
                    className="w-[98%] h-[490px] ml-1"
                    />
                </ ReactCrop> <br />
                <div className="flex justify-end gap-4">
                  <button className=" bg-sky-400 rounded text-black font-bold w-[170px] h-[50px]"
                    onClick={handleDontCrop}
                  >
                    Don't want to crop
                  </button>
                  <button className=" bg-green-400 text-blacK font-bold w-[170px] h-[50px]"
                    onClick={handleCropFunc}
                  >
                    Click Ok
                  </button>
                </div>
        ...
        {/* 
      {
        console.log(Mainsrc != null ? Mainsrc : " ")
      } */}

        {/* {
        showImage && (<>
          <Image src={showImage} alt="Cropped images" className="" />
        </>)
      } */}
        ...
        {/*  billing popUp-------commented-in-1/5/24 don't need try to remove this  */}
        {/* {
        billPopUp && (
          <div className="Result-PopUp  fixed top-0 left-1 mr-1 w-[90%] sm:w-[100%] z-[1472384632746700000]">
            <div className="grid w-[100vw] h-[100%] justify-center align-middle">
              <section className=' grid grid-cols-1 mt-2 rounded  justify-center align-middle w-[100vw] p-4 h-[96vh]  bg-gray-200  '>
                <div className='flex w-full justify-end '>
                  <button
                    style={{ color: 'red' }}
                    className="text-3xl mr-[5px] sm:mr-[25px] hover:drop-shadow-xl rounded-[50%] pt-[13px]  hover:bg-light-gray w-[60px] h-[60px] flex justify-center align-middle"
                    onClick={() => {
                      setBillPopUp(false)
