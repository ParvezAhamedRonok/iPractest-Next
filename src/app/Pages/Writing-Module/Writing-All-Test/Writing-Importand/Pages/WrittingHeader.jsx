...
import "../../WrittingAllStyles/WrittingHeader.css";
...
function Header({ handleIncressFontSize, handleDecressFontSize }) {
    ...
    // main Rendering--------------
    return (
        <section className='W-HeaderSection'>
            ...
            {toggleTestInfo && (<div className="first_row">
                ...
                <div className="divs_4 cursor-pointer" onClick={backtoHomePage}>
                    <Image src={logo} alt="home logo image.." />
                </div>
            ...
            <div className="second_row">
                ...
                <div className="icons-manu">
                    <ul className='icons'>
                        ...
                        {/* handle_panels_FontSize by this clicking functions. & set Flex by Tailwind Css....*/}
