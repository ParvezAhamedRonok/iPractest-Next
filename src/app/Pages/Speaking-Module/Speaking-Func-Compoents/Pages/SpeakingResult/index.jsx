...
export default function Index() {
    ...
    //(retriveJsonData.sectionNo)
    const { speakingStepsNo, setSpeakingStepNo } = useStateContext();
    let questionStepColorArr = JSON.parse(questionStep);
    ...
    var numbers = [];
    for (let a = 0; a < retriveJsonData.questionStepNumber && retriveJsonData.questionStepNumber; a++) {
        numbers.push(a)
    }
    ...
    useEffect(() => {
        ...
        setSpeakingScores(localStorage.getItem("showSpeakingResult") && localStorage.getItem("showSpeakingResult"))
        setquestionStep(localStorage.getItem("questionStepColorArr") && localStorage.getItem("questionStepColorArr"))
    ...
    const LaxicalGrramerSugges = () => {
        var sentData = {
            "textData": retriveJsonData.userSpeechAnsData
        }
        // let someText = retriveJsonData.userSpeechAnsData.replace(/(\r\n|\n|\r)/gm, "");
    ...
    const SubordinateLinkingWords = () => {
        if (retriveJsonData.userSpeechAnsData) {
            let words = retriveJsonData.userSpeechAnsData.toLowerCase();
    ...
    const makePronaunicationStatement = () => {
        if (retriveJsonData.PronaunacationsScore < 5) {
            setPronaunicationStatement("Your Pronaunacation is not so good")
        } else if (retriveJsonData.PronaunacationsScore <= 6.5) {
    ...
    console.log(SpeakingImprovement)
                ...
                <div className="m-auto grid justify-center align-middle w-full sm:w-[750px] shadow-lg rounded p-[10px] sm:p-[20px] relative">
                    ...
                    <div className="mb-2 m-auto w-[120px] h-[120px]">
                        ...
                        <AnimatedProgressProvider
                            valueStart={0}
                            valueEnd={Number(retriveJsonData.ieltsResult) / 10 * 100}
                            duration={1.5}
                    ...
                    <div className="w-full grid mb-2  justify-center gap-0 mt-1  h-auto  box-border " >
                        {
                            retriveJsonData.questionStepNumber && (
                                        ...
                                        <div className="flex justify-center translate-y-[-20px]  align-middle ">
                                            {
                                                firsLineSteps.map((items, i, { length }) => {
                                                    let matchItem = questionStepColorArr.filter(x => parseInt(x) == items);
                                                ...
                                                <div className='flex justify-between w-full align-middle pl-[10px] pt-[17px] pr-[10px]'>
                                                    <div className='p-1 flex justify-center align-middle gap-1'>
                                                        <div className='p-1 rounded-[50%] bg-white w-[60px] h-[60px]'>
                                                            <AnimatedProgressProvider
                                                                valueStart={0}
                                                                valueEnd={Number(retriveJsonData.FluencyAndCoherence
                                                                ) / 10 * 100}
                                                                duration={1.5}
                                                                easingFunction={easeQuadInOut}
                                                            // repeat
                                                ...
                                                <div className='flex justify-between w-full align-middle pl-[10px] pt-[17px] pr-[10px]'>
                                                    <div className='p-1 flex justify-center align-middle gap-1'>
                                                        <div className='p-1 rounded-[50%] bg-white w-[60px] h-[60px]'>
                                                            ...
                                                            <AnimatedProgressProvider
                                                                valueStart={0}
                                                                valueEnd={Number(retriveJsonData.LexicalResourceScore) / 10 * 100}
                                                                duration={1.5}
                                                                easingFunction={easeQuadInOut}
                                                            // repeat
                                                            >
                                                ...
                                                <div className='flex justify-between w-full align-middle pl-[10px] pt-[17px] pr-[10px]'>
                                                    <div className='p-1 flex justify-center align-middle gap-1'>
                                                        <div className='p-1 rounded-[50%] bg-white w-[60px] h-[60px]'>
                                                            ...
                                                            <AnimatedProgressProvider
                                                                valueStart={0}
                                                                valueEnd={Number(retriveJsonData.GrammaticalRangeandAccuracyScore) / 10 * 100}
                                                                duration={1.5}
                                                                easingFunction={easeQuadInOut}
                                                            // repeat
                                                            >
