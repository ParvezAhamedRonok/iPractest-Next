...
export async function Test21Sec2(playScript, setCurrectTimer, converstionSteps, userSpeakingSec2Test, preparationFlag, converstionStepsText) {
    if (converstionSteps == 0 && converstionStepsText == '') {
        ...
        questionElement.innerHTML = `<div style="padding:15px; text-align:justify; border:15px solid orange; border-radius:10px">
                ...
                <h5>  Describe a person you would like to study or work with </h5>
                <h5 class="mt-1 mb-1 text-purple-600">You should say :</h5>
                    <div class="ml-4 p-1 font-bold">
                          <div class="mb-1"><i class='fal fa-check text-white text-[14px]  flex mr-2 p-[5px] bg-red-300  rounded-[50%]'></i> Who is that person?</div>
                         
                          <div class="mb-1"><i class='fal fa-check text-white text-[14px]  flex mr-2 p-[5px] bg-gray-300  rounded-[50%]'></i> Why would you like to study with him/her?</div>
                         
                          <div class="mb-1"><i class='fal fa-check text-white text-[14px]  flex mr-2 p-[5px] bg-green-300  rounded-[50%]'></i>What will you study?</div>
