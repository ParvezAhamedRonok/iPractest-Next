...
import "../../StyleAll/ProggressBars.css";
          ...
          (
            <div className="appie-hero-content text-center translate-x-[13px] translate-y-[0px] sm:translate-y-[-20px]">
              <ul>
                ...
                <li className='mb-3' onClick={() => { history.push("/Pages/Writing-Module/Actual-writing-tests") }} style={{ cursor: "pointer" }}>
                  <a className="item-2" >
                    <i><TfiWrite className='text-xl text-blue-400 mb-[-4px]' /></i>  Writing

                  </a>
                </li>
                <li onClick={() => { history.push("/Pages/Listening-Module/Cambridge-listening-tests") }} style={{ cursor: "pointer" }}>
                  <a >
                ...
                <li onClick={() => { history.push("/Pages/Reading-Module/Cambridge-listening-tests") }} style={{ cursor: "pointer" }}>
                  <a className="item-2" >
