// components/TestimonialHomeTwo.js
import React from "react";
import Carousel from "react-multi-carousel";
import "react-multi-carousel/lib/styles.css";
import { RiStarSFill, RiDoubleQuotesR, RiDoubleQuotesL } from "react-icons/ri";
import Image from "next/image";
import Img1 from "../../../assets/images/LandingImgs/Owl1.jpg"; // Adjust this path as necessary
import Img2 from "../../../assets/images/LandingImgs/Owl2.jpg"; // Adjust this path as necessary
import Img3 from "../../../assets/images/LandingImgs/Owl3.jpeg"; // Adjust this path as necessary
                        ...
                        <div className="slider" key={index}>
                            <div className="imgBox h-[400px] bg-white shadow-md mt-4">
                                <Image
                                    src={imageUrl.url}
                                    alt={imageUrl.name}
                                    className="absolute top-0 rounded-[50%] left-0 right-0 m-auto"
                                    width={110}
                                    height={110}
                                />
