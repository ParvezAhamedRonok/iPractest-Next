                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="appie-fun-fact-content">
                                            ...
                                            <p>
                                                You can track your score on a daily basis. It can help you compare your improvement.
                                            </p>
                                            <div className="row">
                                    ...
                                    <div className="col-lg-6">
                                        <div className="appie-fun-fact-play">
                                            ...
                                            <Image src={FunFactThumb} alt="this is for FunFactThumb iaages" />
                                        </div>
                                    </div>
                                </div>
                            </div>
