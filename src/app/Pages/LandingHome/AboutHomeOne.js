                ...
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-lg-6">
                            ...
                            >
                                <Image src={aboutThumb} alt="this is for aboutThumb iaages" />
                            </div>
                        </div>
                        <div className="col-lg-6">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="appie-traffic-service mb-30">
                                        <div className="icon">
                                            <Image style={{ margin: "12px" }} src={icon5} alt="this is for icon5 iaages" />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="appie-traffic-service item-2 mb-30">
                                        <div className="icon">
                                            <Image style={{ margin: "12px" }} src={icon1} alt="this is for icon1 iaages" />
                                        </div>
                    ...
                    <div className="row align-items-center mt-100 flex-column-reverse flex-lg-row">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div className="appie-traffic-service mb-30 item-3">
                                        <div className="icon">
                                            <Image style={{ margin: "12px" }} src={icon6} alt="this is for icon-6 iaages" />
                                        </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="appie-traffic-service item-2 mb-30 item-4">
                                        <div className="icon">
                                            <Image style={{ margin: "12px" }} src={icon7} alt="this is for icon-7 iaages" />
                                        </div>
                        ...
                        <div className="col-lg-6">
                            <div
                                ...
                                data-wow-delay="400ms"
                            >
                                <Image src={aboutThumb3} alt="this is for aboutThumb3 iaages" />
                            </div>
                        </div>
                    </div>
                </div>
